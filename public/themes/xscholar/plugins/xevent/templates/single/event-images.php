 <?php
	...
	$attachment_ids = get_post_meta($post->ID,'event-gallery',true);
...
<br clear="all">
 <div class="entry-thumbnail">
	...
	<?php
	do_action('xevent_inside_event_thumbnail');
...
<div class="sc-entry-cat">
	...
	<?php  echo get_xevent_categories($post->ID, ', ', '<span class="posted_in">' . _n( 'Category:', 'Categories:', $cat_count, 'spacex' ) . ' ', '</span>' ); ?>

	<?php echo get_xevent_tags($post->ID, ', ', '<span class="tag-links">' . _n( 'Tag:', 'Tags:', $tag_count, 'spacex' ) . ' ', '</span>' ); ?>
	...
	echo '<div class="event-images thumbnails">';
