...
if ( ! class_exists( 'XEVENT_ADMIN_MENUS' ) ) :

/**
 * WC_Admin_Menus Class
 */
class XEVENT_ADMIN_MENUS {
	...
	public function admin_menu() {
		...
		if ( current_user_can( 'manage_options' ) ) {
			$menu[] = array( '', 'read', 'separator-event', '', 'wp-menu-separator event' );
		}
		//$main_page = add_menu_page( __( 'spacex', 'spacex' ), __( 'spacex', 'spacex' ), 'manage_options',  'spacex', null, 'dashicons-welcome-learn-more', '52.5' );
