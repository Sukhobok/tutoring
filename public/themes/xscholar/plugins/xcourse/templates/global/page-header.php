...
if(isset($post))
{
	...
	{
		$type = sc_get_option('tt_page_header_type');
		$page_header_design = sc_get_option('tt_page_header_design');		
	}
...
<div class="page-header page-header-type<?php echo esc_attr($type)?> clearfix">
	...
	elseif(is_home())
	{ 
		$page_title = sc_get_option('tt_blog_title')=='' ? 'Blog' : sc_get_option('tt_blog_title');
		//the_breadcrumb();
	 }
...
?>
	<h1><?php echo apply_filters('xcourse_page_header_title', $page_title);?></h1>
<?php 
