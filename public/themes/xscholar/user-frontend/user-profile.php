                        ...
                        <div class="user-total-spend clearfix">
                            ...
                            <div class="count-order">
                                <h3>Total Spent</h3>
																...
																$currentcy = '';
																if(class_exists("WooCommerce")){
																	$currentcy = get_woocommerce_currency_symbol();
															  }
																?>
                                <div class="user-order-static green text-color complete-order"><?php echo $amount_complete.' '.  $currentcy?><span><?php echo __('Completed', 'spacex')?></span></div>
                                <div class="user-order-static text-color orange processing-order"><?php echo $amount_processing.' '.  $currentcy;?><span><?php echo __('Processing', 'spacex')?></span></div>
                                <div class="user-order-static text-color blue onhold-order"><?php echo $amount_onhold.' '.  $currentcy;?><span><?php echo __('On Hold', 'spacex')?></span></div>
