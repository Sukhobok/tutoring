var session_finished=!1,ts_socket="local"===environment?io.connect("http://studysquare.lh:53101"):io.connect("http://studysquare.com:53101");ts_socket.on("waiting",function(a){console.log(a.time-Math.round(Date.now()/1E3))});ts_socket.on("canceled",function(){session_finished=!0;console.log("canceled")});ts_socket.on("finished",function(){session_finished=!0;console.log("finished")});ts_socket.on("started",function(){console.log("started")});var sourcevid=document.getElementById("webrtc-source"),remotevid=document.getElementById("webrtc-remote"),localStream=null,peerConn=null,mediaConstraints={mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}},_recordRTC=null;
