...
$(document).on("click",".ts-chat-send",function(){""!==$.trim($(".ts-chat-textarea").val())&&(tsChatAdd($.trim($(".ts-chat-textarea").val())),$(".ts-chat-textarea").val(""),ts_socket.emit("tutoring_session_data",{what:"chat",message:$.trim($(".ts-chat-textarea").val())}))});$(document).on("mouseenter",".ts-file-manager-file",function(){$(".ts-file-manager-file-actions",this).fadeIn()}).on("mouseleave",".ts-file-manager-file",function(){$(".ts-file-manager-file-actions",this).fadeOut()});$("#ss-modal-ts-finished-stars").on("click",".ss-modal-ts-finished-star",function(){var a=$(".ss-modal-ts-finished-star").index(this);$(".ss-modal-ts-finished-star").attr("src","/images/rating_empty.png");$(".ss-modal-ts-finished-star").slice(0,a+1).attr("src","/images/rating_full.png");$(this).parent()[0].setAttribute("data-ss-stars-amount",a+1)}).on("mouseenter",".ss-modal-ts-finished-star",function(){var a=$(".ss-modal-ts-finished-star").index(this);$(".ss-modal-ts-finished-star").attr("src","/images/rating_empty.png");
