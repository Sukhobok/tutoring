$(function(){$(".header-notice").html("Please wait ...")});var session_finished=!1,waiting_interval=!1,ts_socket="local"===environment?io.connect("http://studysquare.lh:53101"):io.connect("http://test232.studysquare.com:53101");
...
ts_socket.on("canceled",function(){session_finished=!0;!1!==waiting_interval&&(clearInterval(waiting_interval),$(".header-notice").html(""))});ts_socket.on("finished",function(){session_finished=!0;!1!==waiting_interval&&(clearInterval(waiting_interval),$(".header-notice").html(""))});
ts_socket.on("started",function(a){$.ssModal({modalId:"ts-started"});!1!==waiting_interval&&(clearInterval(waiting_interval),$(".header-notice").html(""));var b=convert_seconds(a.finish_time-Math.round(Date.now()/1E3));$(".header-notice").html('The session will end in <span class="special">'+b+"</span> minutes!");waiting_interval=setInterval(function(a){a=convert_seconds(a-Math.round(Date.now()/1E3));$(".header-notice").html('The session will end in <span class="special">'+a+"</span> minutes!")},
