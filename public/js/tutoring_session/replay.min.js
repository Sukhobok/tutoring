...
b.removeClass("hide")},tsDownloadFile=function(a){window.open("/ajax/session/download_file?file="+a)},tsRemoveFile=function(a){$('.ts-file-manager-file-actions[data-ss-file="'+a+'"]').parents(".ts-file-manager-file").remove()};
