...
$(".layout-main .message-container-main").mCustomScrollbar("scrollTo","bottom");$.ajax({url:"/ajax/messages/send_message",type:"POST",data:{message:a.val(),uid:c}}).done(function(a){});a.val("")}});$(document).on("mouseenter",".friend",function(){$(".friend-hover-content",this).fadeIn();$(".friend-hover",this).fadeIn()}).on("mouseleave",".friend",function(){$(".friend-hover-content",this).fadeOut();$(".friend-hover",this).fadeOut()});$(document).on("click",".ss-friend-remove",function(a){a.stopPropagation();$(this).parents(".friend").remove();a=this.getAttribute("data-ss-uid");$.ajax({url:"/ajax/friendship/remove",type:"POST",data:{id:a}}).done(function(){})});
$(document).on("click",".add-friend-button",function(){var a=this.getAttribute("data-uid");$(this).hide();$.ajax({url:"/ajax/friendship/send_request",type:"POST",data:{id:a}}).done(function(a){})});$(document).on("click",".hire-user-button",function(){$.ssModal({modalId:"hire"})});"hire"===window.location.search.substring(1,5)&&$.ssModal({modalId:"hire"});$("#ss-hire-date1").datepicker();$("#ss-hire-date2").datepicker();$("#ss-hire-date3").datepicker();
