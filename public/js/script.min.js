(function(a){a.Jcrop=function(c,g){function l(a){return Math.round(a)+"px"}function b(b){b=a(b).offset();return[b.left,b.top]}function d(a){return[a.pageX-P[0],a.pageY-P[1]]}function m(b){"object"!==typeof b&&(b={});k=a.extend(k,b);a.each(["onChange","onSelect","onRelease","onDblClick"],function(a,b){"function"!==typeof k[b]&&(k[b]=function(){})})}function e(a,c,d){P=b(u);ca.setCursor("move"===a?a:a+"-resize");if("move"===a)return ca.activateHandlers(f(c),x,d);c=E.getFixed();var e=v(a),g=E.getCorner(v(e));
E.setPressed(E.getCorner(e));E.setCurrent(g);ca.activateHandlers(y(a,c),x,d)}function y(a,b){return function(c){if(k.aspectRatio)switch(a){case "e":c[1]=b.y+1;break;case "w":c[1]=b.y+1;break;case "n":c[0]=b.x+1;break;case "s":c[0]=b.x+1}else switch(a){case "e":c[1]=b.y2;break;case "w":c[1]=b.y2;break;case "n":c[0]=b.x2;break;case "s":c[0]=b.x2}E.setCurrent(c);t.update()}}function f(a){var b=a;ia.watchKeys();return function(a){E.moveOffset([a[0]-b[0],a[1]-b[1]]);b=a;t.update()}}function v(a){switch(a){case "n":return"sw";
case "s":return"nw";case "e":return"nw";case "w":return"ne";case "ne":return"sw";case "nw":return"se";case "se":return"nw";case "sw":return"ne"}}function q(a){return function(c){if(k.disabled||"move"===a&&!k.allowMove)return!1;P=b(u);K=!0;e(a,d(c));c.stopPropagation();c.preventDefault();return!1}}function r(a,b,c){var f=a.width(),d=a.height();f>b&&0<b&&(f=b,d=b/a.width()*a.height());d>c&&0<c&&(d=c,f=c/a.height()*a.width());B=a.width()/f;M=a.height()/d;a.width(f).height(d)}function h(a){return{x:a.x*
B,y:a.y*M,x2:a.x2*B,y2:a.y2*M,w:a.w*B,h:a.h*M}}function x(a){a=E.getFixed();a.w>k.minSelect[0]&&a.h>k.minSelect[1]?(t.enableHandles(),t.done()):t.release();ca.setCursor(k.allowSelect?"crosshair":"default")}function G(a){if(k.disabled||!k.allowSelect)return!1;K=!0;P=b(u);t.disableHandles();ca.setCursor("crosshair");var c=d(a);E.setPressed(c);t.update();ca.activateHandlers(n,x,"touch"===a.type.substring(0,5));ia.watchKeys();a.stopPropagation();a.preventDefault();return!1}function n(a){E.setCurrent(a);
t.update()}function F(){var b=a("<div></div>").addClass(k.baseClass+"-tracker");W&&b.css({opacity:0,backgroundColor:"white"});return b}function I(a){J([a[0]/B,a[1]/M,a[2]/B,a[3]/M]);k.onSelect.call(Z,h(E.getFixed()));t.enableHandles()}function J(a){E.setPressed([a[0],a[1]]);E.setCurrent([a[2],a[3]]);t.update()}function S(){k.disabled=!0;t.disableHandles();t.setCursor("default");ca.setCursor("default")}function Q(){k.disabled=!1;p()}function V(b,c,f){c=c||k.bgColor;k.bgFade&&a.fx.step.hasOwnProperty("backgroundColor")&&
k.fadeTime&&!f?b.animate({backgroundColor:c},{queue:!1,duration:k.fadeTime}):b.css("backgroundColor",c)}function p(a){k.allowResize?a?t.enableOnly():t.enableHandles():t.disableHandles();ca.setCursor(k.allowSelect?"crosshair":"default");t.setCursor(k.allowMove?"move":"default");k.hasOwnProperty("trueSize")&&(B=k.trueSize[0]/w,M=k.trueSize[1]/A);k.hasOwnProperty("setSelect")&&(I(k.setSelect),t.done(),delete k.setSelect);ha.refresh();k.bgColor!=T&&(V(k.shade?ha.getShades():aa,k.shade?k.shadeColor||k.bgColor:
...
position:"absolute",top:0,left:0},z=a(c),N=!0;if("IMG"==c.tagName){if(0!=z[0].width&&0!=z[0].height)z.width(z[0].width),z.height(z[0].height);else{var ea=new Image;ea.src=z[0].src;z.width(ea.width);z.height(ea.height)}var u=z.clone().removeAttr("id").css(L).show();u.width(z.width());u.height(z.height());z.after(u).hide()}else u=z.css(L).show(),N=!1,null===k.shade&&(k.shade=!0);r(u,k.boxWidth,k.boxHeight);var w=u.width(),A=u.height(),aa=a("<div />").width(w).height(A).addClass(k.baseClass+"-holder").css({position:"relative",
backgroundColor:k.bgColor}).insertAfter(z).append(u);k.addClass&&aa.addClass(k.addClass);var X=a("<div />"),Y=a("<div />").width("100%").height("100%").css({zIndex:310,position:"absolute",overflow:"hidden"}),s=a("<div />").width("100%").height("100%").css("zIndex",320),D=a("<div />").css({position:"absolute",zIndex:600}).dblclick(function(){var a=E.getFixed();k.onDblClick.call(Z,a)}).insertBefore(u).append(Y,s);N&&(X=a("<img />").attr("src",u.attr("src")).css(L).width(w).height(A),Y.append(X));da&&
D.css({overflowY:"hidden"});var C=k.boundary,O=F().width(w+2*C).height(A+2*C).css({position:"absolute",top:l(-C),left:l(-C),zIndex:290}).mousedown(G),T=k.bgColor,H=k.bgOpacity,U,R,fa,ga,B,M,K,ja,ka;P=b(u);var ba=function(){function a(){var b={},c=["touchstart","touchmove","touchend"],f=document.createElement("div"),d;try{for(d=0;d<c.length;d++){var e=c[d],e="on"+e,g=e in f;g||(f.setAttribute(e,"return;"),g="function"==typeof f[e]);b[c[d]]=g}return b.touchstart&&b.touchend&&b.touchmove}catch(k){return!1}}
var c;c=!0===k.touchSupport||!1===k.touchSupport?k.touchSupport:a();return{createDragger:function(a){return function(c){if(k.disabled||"move"===a&&!k.allowMove)return!1;P=b(u);K=!0;e(a,d(ba.cfilter(c)),!0);c.stopPropagation();c.preventDefault();return!1}},newSelection:function(a){return G(ba.cfilter(a))},cfilter:function(a){a.pageX=a.originalEvent.changedTouches[0].pageX;a.pageY=a.originalEvent.changedTouches[0].pageY;return a},isSupported:a,support:c}}(),E=function(){function a(){if(!k.aspectRatio){var b=
g-d,h=m-e;U&&Math.abs(b)>U&&(g=0<b?d+U:d-U);R&&Math.abs(h)>R&&(m=0<h?e+R:e-R);ga/M&&Math.abs(h)<ga/M&&(m=0<h?e+ga/M:e-ga/M);fa/B&&Math.abs(b)<fa/B&&(g=0<b?d+fa/B:d-fa/B);0>d&&(g-=d,d-=d);0>e&&(m-=e,e-=e);0>g&&(d-=g,g-=g);0>m&&(e-=m,m-=m);g>w&&(b=g-w,d-=b,g-=b);m>A&&(b=m-A,e-=b,m-=b);d>w&&(b=d-A,m-=b,e-=b);e>A&&(b=e-A,m-=b,e-=b);return f(c(d,e,g,m))}var b=k.aspectRatio,h=k.minSize[0]/B,l=k.maxSize[0]/B,N=g-d,y=m-e,p=Math.abs(N),n=Math.abs(y);0===l&&(l=10*w);p/n<b?(p=m,n*=b,n=0>N?d-n:n+d,0>n?(n=0,p=
Math.abs((n-d)/b),p=0>y?e-p:p+e):n>w&&(n=w,p=Math.abs((n-d)/b),p=0>y?e-p:p+e)):(n=g,p/=b,p=0>y?e-p:e+p,0>p?(p=0,n=Math.abs((p-e)*b),n=0>N?d-n:n+d):p>A&&(p=A,n=Math.abs(p-e)*b,n=0>N?d-n:n+d));n>d?(n-d<h?n=d+h:n-d>l&&(n=d+l),p=p>e?e+(n-d)/b:e-(n-d)/b):n<d&&(d-n<h?n=d-h:d-n>l&&(n=d-l),p=p>e?e+(d-n)/b:e-(d-n)/b);0>n?(d-=n,n=0):n>w&&(d-=n-w,n=w);0>p?(e-=p,p=0):p>A&&(e-=p-A,p=A);return f(c(d,e,n,p))}function b(a){0>a[0]&&(a[0]=0);0>a[1]&&(a[1]=0);a[0]>w&&(a[0]=w);a[1]>A&&(a[1]=A);return[Math.round(a[0]),
Math.round(a[1])]}function c(a,b,d,e){var f=a,g=d,m=b,k=e;d<a&&(f=d,g=a);e<b&&(m=e,k=b);return[f,m,g,k]}function f(a){return{x:a[0],y:a[1],x2:a[2],y2:a[3],w:a[2]-a[0],h:a[3]-a[1]}}var d=0,e=0,g=0,m=0,h,l;return{flipCoords:c,setPressed:function(a){a=b(a);g=d=a[0];m=e=a[1]},setCurrent:function(a){a=b(a);h=a[0]-g;l=a[1]-m;g=a[0];m=a[1]},getOffset:function(){return[h,l]},moveOffset:function(a){var b=a[0];a=a[1];0>d+b&&(b-=b+d);0>e+a&&(a-=a+e);A<m+a&&(a+=A-(m+a));w<g+b&&(b+=w-(g+b));d+=b;g+=b;e+=a;m+=
a},getCorner:function(b){var d=a();switch(b){case "ne":return[d.x2,d.y];case "nw":return[d.x,d.y];case "se":return[d.x2,d.y2];case "sw":return[d.x,d.y2]}},getFixed:a}}(),ha=function(){function b(){return d(E.getFixed())}function d(a){p.top.css({left:l(a.x),width:l(a.w),height:l(a.y)});p.bottom.css({top:l(a.y2),left:l(a.x),width:l(a.w),height:l(A-a.y2)});p.right.css({left:l(a.x2),width:l(w-a.x2)});p.left.css({width:l(a.x)})}function c(){return a("<div />").css({position:"absolute",backgroundColor:k.shadeColor||
k.bgColor}).appendTo(n)}function e(){B||(B=!0,n.insertBefore(u),b(),t.setBgOpacity(1,0,1),X.hide(),f(k.shadeColor||k.bgColor,1),t.isAwake()?m(k.bgOpacity,1):m(1,1))}function f(a,b){V(h(),a,b)}function g(){B&&(n.remove(),X.show(),B=!1,t.isAwake()?t.setBgOpacity(k.bgOpacity,1,1):(t.setBgOpacity(1,1,1),t.disableHandles()),V(aa,0,1))}function m(a,b){B&&(k.bgFade&&!b?n.animate({opacity:1-a},{queue:!1,duration:k.fadeTime}):n.css({opacity:1-a}))}function h(){return n.children()}var B=!1,n=a("<div />").css({position:"absolute",
zIndex:240,opacity:0}),p={top:c(),left:c().height(A),right:c().height(A),bottom:c()};return{update:b,updateRaw:d,getShades:h,setBgColor:f,enable:e,disable:g,resize:function(a,b){p.left.css({height:l(b)});p.right.css({height:l(b)})},refresh:function(){k.shade?e():g();t.isAwake()&&m(k.bgOpacity)},opacity:m}}(),t=function(){function b(d,c){var e=a("<div />").mousedown(q(d)).css({cursor:d+"-resize",position:"absolute",zIndex:c}).addClass("ord-"+d);ba.support&&e.bind("touchstart.jcrop",ba.createDragger(d));
s.append(e);return e}function d(a){var c;for(c=0;c<a.length;c++)b(a[c],M++).addClass("jcrop-dragbar")}function c(b){var d,e;for(e=0;e<b.length;e++){switch(b[e]){case "n":d="hline";break;case "s":d="hline bottom";break;case "e":d="vline right";break;case "w":d="vline"}var f=K,g=b[e],m=d,m=a("<div />").css({position:"absolute",opacity:k.borderOpacity}).addClass(k.baseClass+"-"+m);Y.append(m);f[g]=m}}function e(a){var d;for(d=0;d<a.length;d++){var c=v,f=a[d],g=k.handleSize,m=b(a[d],M++).css({opacity:k.handleOpacity}).addClass(k.baseClass+
"-handle");g&&m.width(g).height(g);c[f]=m}}function f(){var a=E.getFixed();E.setPressed([a.x,a.y]);E.setCurrent([a.x2,a.y2]);g()}function g(a){if(y)return m(a)}function m(a){var b=E.getFixed(),d=b.h;D.width(Math.round(b.w)).height(Math.round(d));var d=b.x,c=b.y;k.shade||X.css({top:l(-c),left:l(-d)});D.css({top:l(c),left:l(d)});k.shade&&ha.updateRaw(b);y||(D.show(),k.shade?ha.opacity(H):B(H,!0),y=!0);a?k.onSelect.call(Z,h(b)):k.onChange.call(Z,h(b))}function B(a,b,d){if(y||b)k.bgFade&&!d?u.animate({opacity:a},
{queue:!1,duration:k.fadeTime}):u.css("opacity",a)}function n(){w=!0;if(k.allowResize)return s.show(),!0}function p(){w=!1;s.hide()}function N(a){a?(ja=!0,p()):(ja=!1,n())}var y,M=370,K={},v={},w=!1;k.dragEdges&&a.isArray(k.createDragbars)&&d(k.createDragbars);a.isArray(k.createHandles)&&e(k.createHandles);k.drawBorders&&a.isArray(k.createBorders)&&c(k.createBorders);a(document).bind("touchstart.jcrop-ios",function(b){a(b.currentTarget).hasClass("jcrop-tracker")&&b.stopPropagation()});var ea=F().mousedown(q("move")).css({cursor:"move",
position:"absolute",zIndex:360});ba.support&&ea.bind("touchstart.jcrop",ba.createDragger("move"));Y.append(ea);p();return{updateVisible:g,update:m,release:function(){p();D.hide();k.shade?ha.opacity(1):B(1);y=!1;k.onRelease.call(Z)},refresh:f,isAwake:function(){return y},setCursor:function(a){ea.css("cursor",a)},enableHandles:n,enableOnly:function(){w=!0},showHandles:function(){w&&s.show()},disableHandles:p,animMode:N,setBgOpacity:B,done:function(){N(!1);f()}}}(),ca=function(){function b(a){g(d(a));
return!1}function c(b){b.preventDefault();b.stopPropagation();K&&(K=!1,m(d(b)),t.isAwake()&&k.onSelect.call(Z,h(E.getFixed())),O.css({zIndex:290}),a(document).unbind(".jcrop"),g=function(){},m=function(){});return!1}function e(a){g(d(ba.cfilter(a)));return!1}function f(a){return c(ba.cfilter(a))}var g=function(){},m=function(){},B=k.trackDocument;B||O.mousemove(b).mouseup(c).mouseout(c);u.before(O);return{activateHandlers:function(d,k,h){K=!0;g=d;m=k;O.css({zIndex:450});h?a(document).bind("touchmove.jcrop",
e).bind("touchend.jcrop",f):B&&a(document).bind("mousemove.jcrop",b).bind("mouseup.jcrop",c);return!1},setCursor:function(a){O.css("cursor",a)}}}(),ia=function(){function b(a){e.hide()}function d(a,b,c){k.allowMove&&(E.moveOffset([b,c]),t.updateVisible(!0));a.preventDefault();a.stopPropagation()}function c(a){if(a.ctrlKey||a.metaKey)return!0;var b=(ka=a.shiftKey?!0:!1)?10:1;switch(a.keyCode){case 37:d(a,-b,0);break;case 39:d(a,b,0);break;case 38:d(a,0,-b);break;case 40:d(a,0,b);break;case 27:k.allowSelect&&
...
p(!0);var Z={setImage:function(a,b){t.release();S();var d=new Image;d.onload=function(){var c=d.height,e=k.boxWidth,f=k.boxHeight;u.width(d.width).height(c);u.attr("src",a);X.attr("src",a);r(u,e,f);w=u.width();A=u.height();X.width(w).height(A);O.width(w+2*C).height(A+2*C);aa.width(w).height(A);ha.resize(w,A);Q();"function"===typeof b&&b.call(Z)};d.src=a},animateTo:function(a,b){var d=a[0]/B,c=a[1]/M,e=a[2]/B,f=a[3]/M;if(!ja){var g=E.flipCoords(d,c,e,f),m=E.getFixed(),h=[m.x,m.y,m.x2,m.y2],n=k.animationDelay,
p=g[0]-h[0],l=g[1]-h[1],y=g[2]-h[2],N=g[3]-h[3],K=0,q=k.swingSpeed,d=h[0],c=h[1],e=h[2],f=h[3];t.animMode(!0);var u=function(){return function(){K+=(100-K)/q;h[0]=Math.round(d+K/100*p);h[1]=Math.round(c+K/100*l);h[2]=Math.round(e+K/100*y);h[3]=Math.round(f+K/100*N);99.8<=K&&(K=100);100>K?(J(h),window.setTimeout(u,n)):(t.done(),t.animMode(!1),"function"===typeof b&&b.call(Z))}}();window.setTimeout(u,n)}},setSelect:I,setOptions:function(a){m(a);p()},tellSelect:function(){return h(E.getFixed())},tellScaled:function(){return E.getFixed()},
setClass:function(a){aa.removeClass().addClass(k.baseClass+"-holder").addClass(a)},disable:S,enable:Q,cancel:function(){t.done();ca.activateHandlers(null,null)},release:t.release,destroy:function(){aa.remove();z.show();z.css("visibility","visible");a(c).removeData("Jcrop")},focus:ia.watchKeys,getBounds:function(){return[w*B,A*M]},getWidgetSize:function(){return[w,A]},getScaleFactor:function(){return[B,M]},getOptions:function(){return k},ui:{holder:aa,selection:D}};W&&aa.bind("selectstart",function(){return!1});
...
createDragbars:["n","s","e","w"],createBorders:["n","s","e","w"],drawBorders:!0,dragEdges:!0,fixedSupport:!0,touchSupport:null,shade:null,boxWidth:0,boxHeight:0,boundary:2,fadeTime:400,animationDelay:20,swingSpeed:3,minSelect:[0,0],maxSize:[0,0],minSize:[0,0],onChange:function(){},onSelect:function(){},onDblClick:function(){},onRelease:function(){}}})(jQuery);(function(a){var c,g,l;function b(a){return String(null===a||void 0===a?"":a).replace(d,function(a){return y[a]})}var d,m,e,y,f,v,q=[],r=0,h,x,G;m={method:"GET",queryParam:"q",searchDelay:300,minChars:1,propertyToSearch:"name",jsonContainer:null,contentType:"json",prePopulate:null,processPrePopulate:!1,hintText:"Type in a search term",noResultsText:"No results",searchingText:"Searching...",deleteText:"&#215;",animateDropdown:!0,placeholder:null,theme:null,zindex:999,resultsLimit:null,enableHTML:!1,
...
m,y){function v(b){f.disabled="boolean"===typeof b?b:!f.disabled;s.attr("disabled",f.disabled);H.toggleClass(f.classes.disabled,f.disabled);C&&L(a(C),l);D.attr("disabled",f.disabled)}function S(){null!==f.tokenLimit&&r>=f.tokenLimit&&(s.hide(),z())}function Q(){if(G!==(G=s.val())){var a=H.width()-s.offset().left-H.offset().left;fa.html(b(G)||b(y.placeholder));s.width(Math.min(H.width(),Math.max(a,fa.width()+30)))}}function V(){var b=a.trim(s.val()).split(f.tokenDelimiter);a.each(b,function(b,d){if(d){a.isFunction(f.onFreeTaggingAdd)&&
(d=f.onFreeTaggingAdd.call(D,d));var c={};c[f.tokenValue]=c[f.propertyToSearch]=d;k(c)}})}function p(b){var d=a(f.tokenFormatter(b)),c=!0===b.readonly?!0:!1;c&&d.addClass(f.classes.tokenReadOnly);d.addClass(f.classes.token).insertBefore(U);c||a("<span>"+f.deleteText+"</span>").addClass(f.classes.tokenDelete).appendTo(d).click(function(){if(!f.disabled)return W(a(this).parent()),D.change(),!1});a.data(d.get(0),"tokeninput",b);q=q.slice(0,O).concat([b]).concat(q.slice(O));O++;da(q,D);r+=1;null!==f.tokenLimit&&
r>=f.tokenLimit&&(s.hide(),z());return d}function k(b){var d=f.onAdd;if(0<r&&f.preventDuplicates){var c=null;H.children().each(function(){var d=a(this),e=a.data(d.get(0),"tokeninput");if(e&&e[y.tokenValue]===b[y.tokenValue])return c=d,!1});if(c){P(c);U.insertAfter(c);Y(s);return}}s.width(0);if(null==f.tokenLimit||r<f.tokenLimit)p(b),s.attr("placeholder",null),S();s.val("");z();a.isFunction(d)&&d.call(D,b)}function P(a){f.disabled||(a.addClass(f.classes.selectedToken),C=a.get(0),s.val(""),z())}function L(a,
b){a.removeClass(f.classes.selectedToken);C=null;b===c?(U.insertBefore(a),O--):b===g?(U.insertAfter(a),O++):(U.appendTo(H),O=r);Y(s)}function W(b){var d=a.data(b.get(0),"tokeninput"),c=f.onDelete,e=b.prevAll().length;e>O&&e--;b.remove();C=null;Y(s);q=q.slice(0,e).concat(q.slice(e+1));0==q.length&&s.attr("placeholder",y.placeholder);e<O&&O--;da(q,D);r-=1;null!==f.tokenLimit&&(s.show().val(""),Y(s));"function"===typeof c&&c.call(D,d)}function da(b,d){var c=a.map(b,function(a){return"function"==typeof f.tokenValue?
f.tokenValue.call(this,a):a[f.tokenValue]});d.val(c.join(f.tokenDelimiter))}function z(){R.hide().empty();T=null}function N(){R.css({position:"absolute",top:H.offset().top+H.outerHeight(),left:H.offset().left,width:H.width(),"z-index":f.zindex}).show()}function ea(a,d){return a.replace(RegExp("(?![^&;]+;)(?!<[^<>]*)("+d.replace(ga,"\\$&")+")(?![^<>]*>)(?![^&;]+;)","gi"),function(a,d){return"<b>"+(f.enableHTML?d:b(d))+"</b>"})}function u(d,c){if(c&&c.length){R.empty();var e=a("<ul/>").appendTo(R);
e.on("mouseover",function(b){w(a(b.target).closest("li"))});e.on("mousedown",function(b){k(a(b.target).closest("li").data("tokeninput"));D.change();return!1});e.hide();f.resultsLimit&&c.length>f.resultsLimit&&(c=c.slice(0,f.resultsLimit));a.each(c,function(b,c){var g=f.resultsFormatter(c),g=g.replace(RegExp("(?![^&;]+;)(?!<[^<>]*)("+c[f.propertyToSearch].replace(ga,"\\$&")+")(?![^<>]*>)(?![^&;]+;)","g"),ea(c[f.propertyToSearch],d)),g=a(g).appendTo(e);b%2?g.addClass(f.classes.dropdownItem):g.addClass(f.classes.dropdownItem2);
0===b&&f.onSelectFirstResult&&w(g);a.data(g.get(0),"tokeninput",c)});N();f.animateDropdown?e.slideDown("fast"):e.show()}else f.noResultsText&&(R.html("<p>"+(f.enableHTML?f.noResultsText:b(f.noResultsText))+"</p>"),N())}function w(b){b&&(T&&(a(T).removeClass(f.classes.selectedDropdownItem),T=null),b.addClass(f.classes.selectedDropdownItem),T=b.get(0))}function A(){var d=s.val();d&&d.length&&(C&&L(a(C),g),d.length>=f.minChars?(f.searchingText&&(R.html("<p>"+(f.enableHTML?f.searchingText:b(f.searchingText))+
"</p>"),N()),clearTimeout(x),x=setTimeout(function(){aa(d)},f.searchDelay)):z())}function aa(b){var d=b+X(),c=h.get(d);if(c)"function"===typeof f.onCachedResult&&(c=f.onCachedResult.call(D,c)),u(b,c);else if(f.url){var c=X(),e={data:{}};-1<c.indexOf("?")?(c=c.split("?"),e.url=c[0],c=c[1].split("&"),a.each(c,function(a,b){var d=b.split("=");e.data[d[0]]=d[1]})):e.url=c;e.data[f.queryParam]=b;e.type=f.method;e.dataType=f.contentType;f.crossDomain&&(e.dataType="jsonp");e.success=function(a){h.add(d,
f.jsonContainer?a[f.jsonContainer]:a);"function"===typeof f.onResult&&(a=f.onResult.call(D,a));s.val()===b&&u(b,f.jsonContainer?a[f.jsonContainer]:a)};if(y.onSend)y.onSend(e);a.ajax(e)}else f.local_data&&(c=a.grep(f.local_data,function(a){return-1<a[f.propertyToSearch].toLowerCase().indexOf(b.toLowerCase())}),h.add(d,c),"function"===typeof f.onResult&&(c=f.onResult.call(D,c)),u(b,c))}function X(){var a=f.url;"function"===typeof f.url&&(a=f.url.call(f));return a}function Y(a){setTimeout(function(){a.focus()},
...
f.idPrefix+d.id).focus(function(){if(f.disabled)return!1;if((null===f.tokenLimit||f.tokenLimit!==r)&&f.hintText)R.html("<p>"+(f.enableHTML?f.hintText:b(f.hintText))+"</p>"),N();H.addClass(f.classes.focused)}).on("blur",function(b){b=a(b.target);z();f.allowFreeTagging&&V();b.val("");H.removeClass(f.classes.focused)}).bind("keyup keydown blur update",Q).on("keydown",function(b){var d,e;e=a(b.target);switch(b.keyCode){case 37:case 39:case 38:case 40:0===e.val().length?(d=U.prev(),e=U.next(),d.length&&
...
v(!0);a.isFunction(f.onReady)&&f.onReady.call();this.clear=function(){H.children("li").each(function(){0===a(this).children("input").length&&W(a(this))})};this.add=function(a){k(a)};this.remove=function(b){H.children("li").each(function(){if(0===a(this).children("input").length){var d=a(this).data("tokeninput"),c=!0,e;for(e in b)if(b[e]!==d[e]){c=!1;break}c&&W(a(this))}})};this.getTokens=function(){return q};this.toggleDisabled=function(a){v(a)};Q();var ga=RegExp("[.\\\\+*?\\[\\^\\]$(){}=!<>|:\\-]",
...
g=e.children(".mCSB_draggerContainer"),f=g.children(".mCSB_dragger");if(b.data("horizontalScroll")){var l=e.children(".mCSB_buttonLeft"),q=e.children(".mCSB_buttonRight"),r=d.width();b.data("autoExpandHorizontalScroll")&&c.css({position:"absolute",width:"auto"}).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({width:c.outerWidth(),position:"relative"}).unwrap();var h=c.outerWidth()}else var x=e.children(".mCSB_buttonUp"),G=e.children(".mCSB_buttonDown"),
n=d.height(),F=c.outerHeight();F>n&&!b.data("horizontalScroll")?(e.css("display","block"),r=g.height(),b.data("autoDraggerLength")&&(h=Math.round(n/F*r),e=f.data("minDraggerHeight"),h<=e?f.css({height:e}):h>=r-10?f.css({height:r-10}):f.css({height:h}),f.children(".mCSB_dragger_bar").css({"line-height":f.height()+"px"})),h=f.height(),b.data("scrollAmount",(F-n)/(r-h)).mCustomScrollbar("scrolling",d,c,g,f,x,G,l,q),d=Math.abs(c.position().top),b.mCustomScrollbar("scrollTo",d,{scrollInertia:0,trigger:"internal"})):
h>r&&b.data("horizontalScroll")?(e.css("display","block"),n=g.width(),b.data("autoDraggerLength")&&(F=Math.round(r/h*n),e=f.data("minDraggerWidth"),F<=e?f.css({width:e}):F>=n-10?f.css({width:n-10}):f.css({width:F})),F=f.width(),b.data("scrollAmount",(h-r)/(n-F)).mCustomScrollbar("scrolling",d,c,g,f,x,G,l,q),d=Math.abs(c.position().left),b.mCustomScrollbar("scrollTo",d,{scrollInertia:0,trigger:"internal"})):(d.unbind("mousewheel focusin"),b.data("horizontalScroll")?f.add(c).css("left",0):f.add(c).css("top",
0),b.data("alwaysShowScrollbar")?b.data("horizontalScroll")?b.data("horizontalScroll")&&f.css({width:g.width()}):f.css({height:g.height()}):(e.css("display","none"),c.addClass("mCS_no_scrollbar")),b.data({bindEvent_mousewheel:!1,bindEvent_focusin:!1}))},scrolling:function(b,d,c,e,l,f,v,q){function r(a,b,d,c){h.data("horizontalScroll")?h.mCustomScrollbar("scrollTo",e.position().left-b+c,{moveDragger:!0,trigger:"internal"}):h.mCustomScrollbar("scrollTo",e.position().top-a+d,{moveDragger:!0,trigger:"internal"})}
var h=a(this);if(!h.data("bindEvent_scrollbar_drag")){var x,G,n,F,I;a.support.pointer?(n="pointerdown",F="pointermove",I="pointerup"):a.support.msPointer&&(n="MSPointerDown",F="MSPointerMove",I="MSPointerUp");a.support.pointer||a.support.msPointer?(e.bind(n,function(b){b.preventDefault();h.data({on_drag:!0});e.addClass("mCSB_dragger_onDrag");var d=a(this),c=d.offset(),f=b.originalEvent.pageX-c.left;b=b.originalEvent.pageY-c.top;f<d.width()&&(0<f&&b<d.height()&&0<b)&&(x=b,G=f)}),a(document).bind(F+
"."+h.data("mCustomScrollbarIndex"),function(a){a.preventDefault();if(h.data("on_drag")){var b=e.offset();r(x,G,a.originalEvent.pageY-b.top,a.originalEvent.pageX-b.left)}}).bind(I+"."+h.data("mCustomScrollbarIndex"),function(a){h.data({on_drag:!1});e.removeClass("mCSB_dragger_onDrag")})):(e.bind("mousedown touchstart",function(b){b.preventDefault();b.stopImmediatePropagation();var d=a(this),c=d.offset(),f;"touchstart"===b.type?b=b.originalEvent.touches[0]||b.originalEvent.changedTouches[0]:(h.data({on_drag:!0}),
e.addClass("mCSB_dragger_onDrag"));f=b.pageX-c.left;c=b.pageY-c.top;f<d.width()&&(0<f&&c<d.height()&&0<c)&&(x=c,G=f)}).bind("touchmove",function(b){b.preventDefault();b.stopImmediatePropagation();b=b.originalEvent.touches[0]||b.originalEvent.changedTouches[0];var d=a(this).offset();r(x,G,b.pageY-d.top,b.pageX-d.left)}),a(document).bind("mousemove."+h.data("mCustomScrollbarIndex"),function(a){if(h.data("on_drag")){var b=e.offset();r(x,G,a.pageY-b.top,a.pageX-b.left)}}).bind("mouseup."+h.data("mCustomScrollbarIndex"),
...
Math.abs(d.position().left));if(0<b&&0!==k||0>b&&k!==l)a.preventDefault(),a.stopImmediatePropagation();h.mCustomScrollbar("scrollTo",g-b*f,{trigger:"internal"})}),h.data({bindEvent_mousewheel:!0}));if(h.data("scrollButtons_enable"))if("pixels"===h.data("scrollButtons_scrollType")){h.data("horizontalScroll")?(q.add(v).unbind("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend",W,da),h.data({bindEvent_buttonsContinuous_x:!1}),h.data("bindEvent_buttonsPixels_x")||
(q.bind("click",function(a){a.preventDefault();L(Math.abs(d.position().left)+h.data("scrollButtons_scrollAmount"))}),v.bind("click",function(a){a.preventDefault();L(Math.abs(d.position().left)-h.data("scrollButtons_scrollAmount"))}),h.data({bindEvent_buttonsPixels_x:!0}))):(f.add(l).unbind("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend",W,da),h.data({bindEvent_buttonsContinuous_y:!1}),h.data("bindEvent_buttonsPixels_y")||(f.bind("click",
function(a){a.preventDefault();L(Math.abs(d.position().top)+h.data("scrollButtons_scrollAmount"))}),l.bind("click",function(a){a.preventDefault();L(Math.abs(d.position().top)-h.data("scrollButtons_scrollAmount"))}),h.data({bindEvent_buttonsPixels_y:!0})));var L=function(a){e.data("preventAction")||(e.data("preventAction",!0),h.mCustomScrollbar("scrollTo",a,{trigger:"internal"}))}}else{if(h.data("horizontalScroll")){if(q.add(v).unbind("click"),h.data({bindEvent_buttonsPixels_x:!1}),!h.data("bindEvent_buttonsContinuous_x")){q.bind("mousedown touchstart MSPointerDown pointerdown",
function(a){a.preventDefault();var b=z();h.data({mCSB_buttonScrollRight:setInterval(function(){h.mCustomScrollbar("scrollTo",Math.abs(d.position().left)+b,{trigger:"internal",scrollEasing:"easeOutCirc"})},17)})});var W=function(a){a.preventDefault();clearInterval(h.data("mCSB_buttonScrollRight"))};q.bind("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout",W);v.bind("mousedown touchstart MSPointerDown pointerdown",function(a){a.preventDefault();var b=z();h.data({mCSB_buttonScrollLeft:setInterval(function(){h.mCustomScrollbar("scrollTo",
...
(b.bind("mouseenter",function(a){b.addClass("mCS-mouse-over");g.showScrollbar.call(b.children(".mCSB_scrollTools"))}).bind("mouseleave touchend",function(a){b.removeClass("mCS-mouse-over");"mouseleave"===a.type&&g.hideScrollbar.call(b.children(".mCSB_scrollTools"))}),h.data({bindEvent_autoHideScrollbar:!0}))},scrollTo:function(b,d){function c(a){if(e.data("mCustomScrollbarIndex"))switch(this.mcs={top:q.position().top,left:q.position().left,draggerTop:x.position().top,draggerLeft:x.position().left,
topPct:Math.round(100*Math.abs(q.position().top)/Math.abs(q.outerHeight()-v.height())),leftPct:Math.round(100*Math.abs(q.position().left)/Math.abs(q.outerWidth()-v.width()))},a){case "onScrollStart":e.data("mCS_tweenRunning",!0).data("onScrollStart_Callback").call(e,this.mcs);break;case "whileScrolling":e.data("whileScrolling_Callback").call(e,this.mcs);break;case "onScroll":e.data("onScroll_Callback").call(e,this.mcs);break;case "onTotalScrollBack":e.data("onTotalScrollBack_Callback").call(e,this.mcs);
break;case "onTotalScroll":e.data("onTotalScroll_Callback").call(e,this.mcs)}}var e=a(this),l={moveDragger:!1,trigger:"external",callbacks:!0,scrollInertia:e.data("scrollInertia"),scrollEasing:e.data("scrollEasing")};d=a.extend(l,d);var f,v=e.children(".mCustomScrollBox"),q=v.children(".mCSB_container"),r=v.children(".mCSB_scrollTools"),h=r.children(".mCSB_draggerContainer"),x=h.children(".mCSB_dragger"),l=draggerSpeed=d.scrollInertia,G,n,F,I;if(!q.hasClass("mCS_no_scrollbar")&&(e.data({mCS_trigger:d.trigger}),
e.data("mCS_Init")&&(d.callbacks=!1),b||0===b))"number"===typeof b?d.moveDragger?(f=b,b=e.data("horizontalScroll")?x.position().left*e.data("scrollAmount"):x.position().top*e.data("scrollAmount"),draggerSpeed=0):f=b/e.data("scrollAmount"):"string"===typeof b&&(f="top"===b?0:"bottom"===b&&!e.data("horizontalScroll")?q.outerHeight()-v.height():"left"===b?0:"right"===b&&e.data("horizontalScroll")?q.outerWidth()-v.width():"first"===b?e.find(".mCSB_container").find(":first"):"last"===b?e.find(".mCSB_container").find(":last"):
e.find(b),1===f.length?(b=e.data("horizontalScroll")?f.position().left:f.position().top,f=b/e.data("scrollAmount")):f=b=f),e.data("horizontalScroll")?(e.data("onTotalScrollBack_Offset")&&(n=-e.data("onTotalScrollBack_Offset")),e.data("onTotalScroll_Offset")&&(I=v.width()-q.outerWidth()+e.data("onTotalScroll_Offset")),0>f?(f=b=0,clearInterval(e.data("mCSB_buttonScrollLeft")),n||(G=!0)):f>=h.width()-x.width()?(f=h.width()-x.width(),b=v.width()-q.outerWidth(),clearInterval(e.data("mCSB_buttonScrollRight")),
I||(F=!0)):b=-b,(h=e.data("snapAmount"))&&(b=Math.round(b/h)*h-e.data("snapOffset")),g.mTweenAxis.call(this,x[0],"left",Math.round(f),draggerSpeed,d.scrollEasing),g.mTweenAxis.call(this,q[0],"left",Math.round(b),l,d.scrollEasing,{onStart:function(){d.callbacks&&!e.data("mCS_tweenRunning")&&c("onScrollStart");e.data("autoHideScrollbar")&&!e.data("alwaysShowScrollbar")&&g.showScrollbar.call(r)},onUpdate:function(){d.callbacks&&c("whileScrolling")},onComplete:function(){d.callbacks&&(c("onScroll"),(G||
n&&q.position().left>=n)&&c("onTotalScrollBack"),(F||I&&q.position().left<=I)&&c("onTotalScroll"));x.data("preventAction",!1);e.data("mCS_tweenRunning",!1);e.data("autoHideScrollbar")&&!e.data("alwaysShowScrollbar")&&(v.hasClass("mCS-mouse-over")||g.hideScrollbar.call(r))}})):(e.data("onTotalScrollBack_Offset")&&(n=-e.data("onTotalScrollBack_Offset")),e.data("onTotalScroll_Offset")&&(I=v.height()-q.outerHeight()+e.data("onTotalScroll_Offset")),0>f?(f=b=0,clearInterval(e.data("mCSB_buttonScrollUp")),
n||(G=!0)):f>=h.height()-x.height()?(f=h.height()-x.height(),b=v.height()-q.outerHeight(),clearInterval(e.data("mCSB_buttonScrollDown")),I||(F=!0)):b=-b,(h=e.data("snapAmount"))&&(b=Math.round(b/h)*h-e.data("snapOffset")),g.mTweenAxis.call(this,x[0],"top",Math.round(f),draggerSpeed,d.scrollEasing),g.mTweenAxis.call(this,q[0],"top",Math.round(b),l,d.scrollEasing,{onStart:function(){d.callbacks&&!e.data("mCS_tweenRunning")&&c("onScrollStart");e.data("autoHideScrollbar")&&!e.data("alwaysShowScrollbar")&&
g.showScrollbar.call(r)},onUpdate:function(){d.callbacks&&c("whileScrolling")},onComplete:function(){d.callbacks&&(c("onScroll"),(G||n&&q.position().top>=n)&&c("onTotalScrollBack"),(F||I&&q.position().top<=I)&&c("onTotalScroll"));x.data("preventAction",!1);e.data("mCS_tweenRunning",!1);e.data("autoHideScrollbar")&&!e.data("alwaysShowScrollbar")&&(v.hasClass("mCS-mouse-over")||g.hideScrollbar.call(r))}})),e.data("mCS_Init")&&e.data({mCS_Init:!1})},stop:function(){var b=a(this),d=b.children().children(".mCSB_container"),
...
Date.now():(new Date).getTime()}function q(){J||x.call();J=v()-F;r();J>=a._time&&(a._time=J>a._time?J+I-(J-a._time):J+I-1,a._time<J+1&&(a._time=J+1));a._time<e?a._id=_request(q):n.call()}function r(){0<e?(a.currVal=h(a._time,S,V,e,l),Q[c]=Math.round(a.currVal)+"px"):Q[c]=g+"px";G.call()}function h(a,b,c,d,e){switch(e){case "linear":return c*a/d+b;case "easeOutQuad":return a/=d,-c*a*(a-2)+b;case "easeInOutQuad":a/=d/2;if(1>a)return c/2*a*a+b;a--;return-c/2*(a*(a-2)-1)+b;case "easeOutCubic":return a/=
...
$(document).on("click",".ss-chat-open-user-conversation",function(a){a.stopPropagation();ss_chat_open_user_conversation(this.getAttribute("data-ss-uid"))});
