...
window.onfocus=function(){window_has_focus=!0;ss_notifications=0;setTimeout(function(){document.title=old_document_title},1E3)};var new_ss_notification=function(){window_has_focus||(ss_notifications++,document.title="("+notifications+") "+document_title,audio_alert())};var socket="local"===environment?io.connect("http://studysquare.lh:53100"):io.connect("http://studysquare.com:53100");socket.on("duplicate_session",function(){$.ssModal({modalId:"duplicate-session",canBeClosed:0})});$(document).on("click",".ss-modal-bg",function(){$.ssModal({action:"try_close"})});$(document).on("keyup",function(a){27==a.keyCode&&$.ssModal({action:"try_close"})});$(document).on("click",".ss-modal-close",function(){$.ssModal({action:"close"})});
