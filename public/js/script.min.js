...
$(".message-content p",b).text(e.message);$(".message-time",b)[0].setAttribute("data-time",e.created_at);$(".message-picture img",b)[0].setAttribute("src",e.message_picture);$(".message-container-main .mCSB_container").append(b);b.removeClass("hide");convert_time();$(".layout-main .message-container-main").mCustomScrollbar("update");$(".layout-main .message-container-main").mCustomScrollbar("scrollTo","bottom")})})});
$(".layout-main.message-page").on("click",".message-send",function(){var a=$(".message-new textarea"),e=$(this)[0].getAttribute("data-uid");a.val($.trim(a.val()));if(""!=a.val()){var l=$(".snippet-message").clone().removeClass("snippet-message");l.addClass("sent-message");$(".message-content p",l).text(a.val());$(".message-time",l)[0].setAttribute("data-time",Math.round(new Date/1E3));$(".message-container-main .mCSB_container").append(l);l.removeClass("hide");convert_time();$(".layout-main .message-container-main").mCustomScrollbar("update");
