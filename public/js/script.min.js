...
e.addClass("mCSB_dragger_onDrag"));f=b.pageX-c.left;c=b.pageY-c.top;f<d.width()&&(0<f&&c<d.height()&&0<c)&&(w=c,G=f)}).bind("touchmove",function(b){b.preventDefault();b.stopImmediatePropagation();b=b.originalEvent.touches[0]||b.originalEvent.changedTouches[0];var d=a(this).offset();r(w,G,b.pageY-d.top,b.pageX-d.left)}),a(document).bind("mousemove."+h.data("mCustomScrollbarIndex"),function(a){if(h.data("on_drag")){var b=e.offset();r(w,G,a.pageY-b.top,a.pageX-b.left)}}).bind("mouseup."+h.data("mCustomScrollbarIndex"),
